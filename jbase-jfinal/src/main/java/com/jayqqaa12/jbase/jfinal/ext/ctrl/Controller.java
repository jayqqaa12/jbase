...
import com.jayqqaa12.jbase.jfinal.ext.model.vo.Form;
import com.jayqqaa12.jbase.jfinal.ext.auto.BaseService;
...
public class Controller<T> extends com.jfinal.core.Controller {
	...
	public <M> M getModel(Class<M> modelClass) {
		return (M) Injector.injectModel(modelClass, getRequest(), false);
	}
	...
	public <M> M getModel(Class<M> modelClass, String modelName) {
		return (M) Injector.injectModel(modelClass, modelName, getRequest(), false);
	}
	
	
	@Override
	public <M> M getModel(Class<M> modelClass, boolean skipConvertError) {
		return (M) Injector.injectModel(modelClass, getRequest(), skipConvertError);
	}
