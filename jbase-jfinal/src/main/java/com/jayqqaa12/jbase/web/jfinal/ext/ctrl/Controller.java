...
public class Controller<T> extends com.jfinal.core.Controller {
	...
	public <M> M getModel(Class<M> modelClass) {
		return (M)com.jayqqaa12.jbase.web.jfinal.ext.ctrl.Injector.injectModel(modelClass, getRequest(), false);
	}
	...
	public <M> M getModel(Class<M> modelClass, String modelName) {
		return (M)com.jayqqaa12.jbase.web.jfinal.ext.ctrl.Injector.injectModel(modelClass, modelName, getRequest(), false);
	}
	
	
	@Override
	public <M> M getModel(Class<M> modelClass, boolean skipConvertError) {
		return (M)com.jayqqaa12.jbase.web.jfinal.ext.ctrl.Injector.injectModel(modelClass, getRequest(), skipConvertError);
	}
