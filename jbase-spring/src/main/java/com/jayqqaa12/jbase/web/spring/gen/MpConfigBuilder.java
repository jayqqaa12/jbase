 ...
 * the License.
 */
package com.jayqqaa12.jbase.web.spring.gen;
 ...
 *
 */
public class MpConfigBuilder extends ConfigBuilder{
	 ...
	 *            全局配置
	 */
	public MpConfigBuilder(PackageConfig packageConfig, DataSourceConfig dataSourceConfig, StrategyConfig strategyConfig,
			...
			while (results.next()) {
				...
				if (StringUtils.isNotEmpty(tableName)) {
					...
					if (StringUtils.isNotEmpty(tableInfo.getName())) {
						...
						for (String pre : config.getTablePrefix()) {
