...
public final class EmlKit {
     ...
     */
    public EmlKit(String server, String eml, String uid, String pwd) throws MessagingException {
        this.server = server;
        this.uid = uid;
        this.pwd = pwd;
     ...
     */
    public EmlKit setSubject(String subject) throws MessagingException {
     ...
     * @throws javax.mail.MessagingException 发生错误时抛出此异常
     */
    public EmlKit setBody(String html) throws MessagingException {
     ...
     * @throws javax.mail.MessagingException 发生错误时抛出此异常
     */
    public EmlKit addTo(String to) throws MessagingException {
     ...
     */
    public EmlKit addCc(String cc) throws MessagingException {
     ...
     * @see #addTo(String)
     */
    public EmlKit addBcc(String bcc) throws MessagingException {
     ...
     */
    public EmlKit addFile(String filePath) throws MessagingException {
        MimeBodyPart mbp = new MimeBodyPart();
     ...
     * @see #addFile(String)
     */
    public EmlKit addFile(File file) throws MessagingException {
