...
public class SensitiveWordKit {
	...
	public static void init(String filename) {
		sensitiveWord = new SensitiveWord(PathKit.getRootClassPath()+File.separator+filename) ;
	}
	...
	public static int CheckSensitiveWord(String txt, int beginIndex ) {
		...
		if(sensitiveWord==null) throw new NullPointerException("must init() SensitiveWordKit before use");
